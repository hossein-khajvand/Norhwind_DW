...
|---|---|---|
| Sales | Hossein Khajvand / BI Team | Maintain sales logic and KPI definitions |
...
|---|---|---|---|
| `1.0.0` | `2026-08-10` | Hossein Khajvand | Initial Data Catalog for Sales ETL / Data Warehouse project |
...
**Maintained by:** Hossein Khajvand  
**Format:** Markdown (`.md`)  
